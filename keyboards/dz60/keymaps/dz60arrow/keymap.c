...
uint32_t layer_state_set_user(uint32_t state) {
	switch (biton32(state)) {
		case _02_MODIFIER:
			rgblight_setrgb (0xff,  0xc7, 0x74);
			break;
		default:
			rgblight_setrgb (0xb2,  0x48, 0x59);
			break;
	}
	return state;
}
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_01_BASE] = LAYOUT_dz60arrow(
		...
		KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, _01_MACRO, TO(1), KC_LEFT, KC_DOWN, KC_RGHT),
	...
	[_02_MODIFIER] = LAYOUT_dz60arrow(
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
		KC_TRNS, KC_TRNS, KC_TRANS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
